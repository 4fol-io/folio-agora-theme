...
Theme based on GEF UOC Framework for Agora Folio blog types
...
= 1.0.1 =
* Ajax load content in lists
* Preload thumbs to set object fit

= 1.0.2 =
* Ajax load comments in lists
* Comments tree view
...
* Based on GEF Framework http://cv.uoc.edu/UOC/GEFv2/
