<?php
/**
 * Agora Folio custom navigation walker (bootstrap)
 *
 * @package AgoraFolio
 */

namespace AgoraFolio\Nav;
 ...
 * Filter menu items
 */
function menu_objects_filter($sorted_menu_objects, $args) {
    return $sorted_menu_objects;
}
// add_filter('wp_nav_menu_objects', __NAMESPACE__ . '\\menu_objects_filter', 10, 2);
