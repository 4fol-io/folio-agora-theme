<?php
/**
 * Agora Folio image sizes & image customizations
 *
 * @package AgoraFolio
 */

namespace AgoraFolio\Images;
...
function add_image_size_names( $sizes ) {
    return array_merge( $sizes, array(
      'featured-large' => __( 'Featured Large', 'agora-folio' ),
	  'featured-medium' => __( 'Featured Medium', 'agora-folio' ),
      'featured-small' => __( 'Featured Small', 'agora-folio' ),
    ) );
}
